...
export const metadata: Metadata = {
  ...
  description: "قوانین استفاده از پلتفرم تامین برای خریداران و فروشندگان.",
...
export default function TermsPage() {
  return (
    <StaticPage title="قوانین و مقررات">
      <p>با استفاده از تامین، شما با موارد زیر موافقت می‌کنید:</p>
      <ol className="list-decimal space-y-2 pr-5">
        ...
        <li>تامین در قبال معاملات انجام‌شده خارج از پلتفرم مسئولیتی ندارد.</li>
      </ol>
